...
If you want drive each motor separately (without regard to group specifics) then you can use the following methods of this class: **Clockwise_Rotation** or **Counterclockwise_Rotation**.
...
void loop() {  
  ...
  motodriver.Counterclockwise_Group_Rotation(128, 2);
}
```
